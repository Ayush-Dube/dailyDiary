...
3. You can't use the same id for multiple elements because id values must be unique in HTML. When you try to select elements by id, only the first one is targeted. This is a fundamental rule of the DOM.   
